...
function Sidebar() {
  ...
  'corsor-pointer font-semibold text-[#F51997] rounded';
          ...
          {!userProfile && (
            <div className="px-2 py-4 hidden xl:block ">
              <p className="text-gray-400 ">
                Login to like and share videos
              </p>
              <div className="pr-4 ">
                <GoogleLogin
                clientId=''
                render={(renderProps) => (
                  <button 
                  className="bg-white text-lg text-[#F51997] border-[1px] border-[#F51997] font-semibold px-6 py-3 
